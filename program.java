...
Date timestamp;
    ...
    public program(Date timestamp, String data, String childReferenceNodeId, String genesisReferenceNodeId, String hashValue, String referenceNodeId) {
        this.timestamp = timestamp;
        this.data = data;
        program.nodeNumber = nodeNumber++ ;
